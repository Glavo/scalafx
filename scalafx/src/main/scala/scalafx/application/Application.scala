...
abstract class Application extends jfxa.Application {
  ...
  lazy val hostService: HostServices = new HostServices(this.getHostServices)

  lazy val parameters: Application.Parameters = ApplicationIncludes.jfxParameters2sfx(this.getParameters)
}
